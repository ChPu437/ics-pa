...
#define immJ() do { *imm = ((SEXT(BITS(i, 31, 31), 12) << 20) | (BITS(i, 19, 12) << 12) | (BITS(i, 20, 20) << 11) | (BITS(i, 30, 21) << 1) | 0);} while(0)
#define immB() do { *imm = ((SEXT(BITS(i, 31, 31), 20) << 12) | (BITS(i, 7, 7) << 11) | (BITS(i, 30, 25) << 5) | (BITS(i, 11, 8) << 1) | 0);} while(0)
